...
import {
  ...
  IoLogOutOutline,
  IoSettingsOutline,
} from "react-icons/io5"; // Importing icons for home, sign out, settings, help, and privacy (not currently used).
    ...
    <div className="w-full text-black">
      ...
      <div className="flex gap-2 mx-4 text-center pt-4 mb-10 flex-col items-center">
        <img
          ...
          alt="LinkCamp Logo"
        />
        <p className="text-4xl font-bold text-red-500 md:text-2xl">LinkCamp</p>
      </div>
      ...
      <ul className="space-y-4 p-4">
        ...
        <li
          className={`flex items-center gap-4 p-2 cursor-pointer border-b-[0.5px] border-gray-100 transition-all duration-300 ease-in-out ${
            userInfo?.userType !== "admin" ? "hidden" : "block"
          } ${
            isActive("/admin-dash")
              ? "text-xl font-bold text-red-600"
              : "text-base"
