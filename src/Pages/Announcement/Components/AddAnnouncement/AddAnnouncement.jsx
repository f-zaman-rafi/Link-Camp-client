...
const AddAnnouncement = () => {
    const [isModalOpen, setIsModalOpen] = useState(false); // State to control the visibility of the announcement modal.
    const [content, setContent] = useState(""); // State to store the text content of the announcement.
    const [photo, setPhoto] = useState(null); // State to store the selected photo file.
    const [isLoading, setIsLoading] = useState(false); // State to track if the announcement is being posted.
    ...
    const openModal = () => {
        setIsModalOpen(true); // Open the announcement modal.
        setTimeout(() => {
    ...
    const closeModal = () => {
        setIsModalOpen(false); // Close the announcement modal.
    ...
    const handlePostSubmit = async () => {
        ...
        try {
            ...
            // Post the announcement data to the server.
            await axiosSecure.post("/teacher/announcement", formData, {
            ...
            window.location.reload(); // Force a page reload to update the announcement feed.
            navigate("/"); // Optionally navigate to the home page after posting.
        } catch (error) {
            // Log and display an error message if the announcement creation fails.
