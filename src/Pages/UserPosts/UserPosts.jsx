...
const UserPosts = () => {
  ...
  const { userInfo, isLoading } = useUserInfo(); // Information about the logged-in user.
  ...
  const { userVotes, votesLoading, voteCounts, voteCountsLoading, handleVote } =
  ...
  if (postsLoading || votesLoading || voteCountsLoading || isLoading)
    return <Loading />;
